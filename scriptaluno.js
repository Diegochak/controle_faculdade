...
btnSalvar.onclick = e => {
  ...
  if (sNome.value == '' || sFuncao.value == '' || sSalario.value == ''|| sCurso.value == ''|| sMateria.value == ''|| SNota.value == '') {
    return
  }
  ...
  if (id !== undefined) {
    ...
    itens.push({'nome': sNome.value, 'funcao': sFuncao.value, 'salario': sSalario.value, 'curso': sCurso.value, 'materia':sMateria.value, 'nota':SNota.value })
  }
